...
### 메모
 ...
 <p>처음에 ArrayList를 사용해서 시간초과가 발생했다, 이 문제는 커서를 기준으로 연속적인 삽입과 삭제가 이루어지므로, 인덱스 기반 탐색이 거의 필요하지 않다.
  <br>따라서 삽입, 삭제에 유리한 LinkedList가 더 적합한 선택이었다</p>
